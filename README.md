...
Кроме того, текущая реализация несколько ошибочна, и я надеюсь, что успею представить исправленную версию с новым интересным функционалом к моменту, когда вы доберетесь до моего проекта :)